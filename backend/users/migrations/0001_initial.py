    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(help_text='вы можете загрузить отображаемое фото', null=True, upload_to='users/avatars', validators=[users.validators.image_validation], verbose_name='Аватар пользователя')),
